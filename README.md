NAILES THIS SHIZNIT! LOVE REACT AND PROGRAMMING!
...
- [x] What steps can you take in your web apps to keep your data secure?
      Have priavte routes and protect the private routes to the data with tokens that can be generated by the server on the back and given to users who have the login information. 
- [x] Describe how web servers work.
   A web server processes incoming network requests over HTTP and several other related protocols. The primary function of a web server is to store, process and deliver web pages to clients
